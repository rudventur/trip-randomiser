...
📰 News — skips the OpenStreetMap search entirely and goes straight to a real, live headline from a free news site, placed on the map at that story's country. It's the fast, always-available option, since it doesn't wait on Overpass at all.
